function Set-TMServiceLogon {
    ...
    .DESCRIPTION
        This function uses either CIM (default) or WMI to set the service password, and 
    ...
    .PARAMETER SystemAccount
        Can be used for setting the built-in system accounts that exist, such as LocalSystem, 
        NT AUTHORITY\NetworkService and NT AUTHORITY\LocalService
    ...
    .EXAMPLE
        Set-TMServiceLogon -ServiceName OurService -NewPassword 'P@ssw0rd' -NewUser
        "COMPANY\User" -ComputerName SERVER1,SERVER2

        This will set the service OurService on SERVER1 and SERVER2to run under 
        COMPANY\USER with a password of "P@ssword"

    .EXAMPLE
        Set-TMServiceLogon -ServiceName OurService -NewPassword 'P@ssword' -ComputerName 
        SERVER1,SERVER2

        This will only change the password service OurService on SERVER1 and SERVER2 to 
        run under "P@ssword"
    ...
    .NOTES
        ...
        Version History:
        2.0 - Error Hanlding - working version
            - listing 15.2
    ...
    PROCESS {
        ...
        foreach ($Computer in $ComputerName) {
            ...
            Do {
                Write-Verbose -Message "[PROCESS] - [$((Get-Date).ToString("yyyy-MM-dd HH:mm:ss"))] - Connect to $Computer on $Protocol"
